...
#     cursor = mydb.cursor()
#     #Check the data base 
#     cursor.execute("DROP DATABASE SQC")
...
#         )    
#     cursor = mydb.cursor()
#     cursor .execute("CREATE DATABASE IF NOT EXISTS SQC")
#     mydb = mysql.connector.connect(
#         host="localhost",
#         user="root",
#         passwd="PixelDcs_Dc0",
...
class SQLDataBase(object):
    ...
    def create_tables(self):   
        ...
        cursor.execute("CREATE TABLE IF NOT EXISTS Lab (lab_id INT NOT NULL, a_id INT NOT NULL, lab_branch VARCHAR(255), lab_unit VARCHAR(255), PRIMARY KEY(lab_id), FOREIGN KEY (a_id) REFERENCES Analyzer(analyzer_id))")
